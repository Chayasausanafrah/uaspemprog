            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="#"><i class="fa fa-cogs nav_icon"></i> Menu <span class="nav-badge">12</span> <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="input_barang.php">Master Barang</a>
								</li>
								<li>
									<a href="input_satuan.php">Master Satuan</a>
								</li>
								<li>
									<a href="input_kategori.php">Master kategori</a>
								</li>
      							<li>
									<a href="input_pelanggan.php">Master Pelanggan</a>
								</li>
								<li>
									<a href="input_Transaksi.php">Master Transaksi</a>
								</li>
      							<li>
